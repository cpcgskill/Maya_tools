...
import sys
import _29ec6114866849fea9beb4e7c69fd81f
_29ec6114866849fea9beb4e7c69fd81f.main = sys.modules.get(__name__)
u'\n:\u521b\u5efa\u65f6\u95f4: 2020/12/30 17:44\n:\u4f5c\u8005: \u82cd\u4e4b\u5e7b\u7075\n:\u6211\u7684\u4e3b\u9875: https://cpcgskill.com\n:QQ: 2921251087\n:\u7231\u53d1\u7535: https://afdian.net/@Phantom_of_the_Cang\n:aboutcg: https://www.aboutcg.org/teacher/54335\n:bilibili: https://space.bilibili.com/351598127\n\n'
import json
import datetime
import _29ec6114866849fea9beb4e7c69fd81f.config as config, _29ec6114866849fea9beb4e7c69fd81f.config as _
reload(config)
from _29ec6114866849fea9beb4e7c69fd81f.config import *
if DEBUG:
    import _29ec6114866849fea9beb4e7c69fd81f.CPMel_Form as CPMel_Form, _29ec6114866849fea9beb4e7c69fd81f.CPMel_Form as _
    reload(CPMel_Form)
    import _29ec6114866849fea9beb4e7c69fd81f.plugins as plugins, _29ec6114866849fea9beb4e7c69fd81f.plugins as _
    reload(plugins)
    import _29ec6114866849fea9beb4e7c69fd81f.setup as setup, _29ec6114866849fea9beb4e7c69fd81f.setup as _
    reload(setup)
    import _29ec6114866849fea9beb4e7c69fd81f.update as update, _29ec6114866849fea9beb4e7c69fd81f.update as _
    reload(update)
from _29ec6114866849fea9beb4e7c69fd81f.CPMel.ui import *
from _29ec6114866849fea9beb4e7c69fd81f.plugins import plugins
from _29ec6114866849fea9beb4e7c69fd81f.setup import show
import _29ec6114866849fea9beb4e7c69fd81f.update as update, _29ec6114866849fea9beb4e7c69fd81f.update as _
