...
import sys
import mid
mid.main = sys.modules.get(__name__)
u'\n:\u521b\u5efa\u65f6\u95f4: 2020/12/30 17:44\n:\u4f5c\u8005: \u82cd\u4e4b\u5e7b\u7075\n:\u6211\u7684\u4e3b\u9875: https://cpcgskill.com\n:QQ: 2921251087\n:\u7231\u53d1\u7535: https://afdian.net/@Phantom_of_the_Cang\n:aboutcg: https://www.aboutcg.org/teacher/54335\n:bilibili: https://space.bilibili.com/351598127\n\n'
import json
import datetime
import mid.config as config, mid.config as _
reload(config)
from mid.config import *
if DEBUG:
    import mid.CPMel_Form as CPMel_Form, mid.CPMel_Form as _
    reload(CPMel_Form)
    import mid.plugins as plugins, mid.plugins as _
    reload(plugins)
    import mid.setup as setup, mid.setup as _
    reload(setup)
    import mid.update as update, mid.update as _
    reload(update)
from mid.CPMel.ui import *
from mid.plugins import plugins
from mid.setup import show
import mid.update as update, mid.update as _
